...
python3 main.py -b 32 -v kfold_ttv --from_scratch --make_figs -m swinv2_cr_tiny_384 --split_factor 10 --gpu_idx 1 2>&1 | tee ./model_testing_leak/swinv2_cr_tiny_384_sf_10.txt
...
python3 main.py -b 32 -v kfold_ttv --from_scratch --make_figs -m swinv2_cr_tiny_384 --split_factor 10 --gpu_idx 1 2>&1 | tee ./model_testing_repeat_1_leak/swinv2_cr_tiny_384_sf_10.txt
...
python3 main.py -b 32 -v kfold_ttv --from_scratch --make_figs -m swinv2_cr_tiny_384 --split_factor 10 --gpu_idx 1 2>&1 | tee ./model_testing_repeat_2_leak/swinv2_cr_tiny_384_sf_10.txt
